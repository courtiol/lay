...
There is hardly any code behind **lay()** (it can be coded in 3 lines), so this is probably just an interim solution before a proper package fulfils the need [note: perhaps this package exists already... perhaps it is [**{slider}**](https://davisvaughan.github.io/slider/)!].
...
It can be used to perform rowwise operations and is very similar to **{lay}**.
It is very efficient but two possible drawbacks are:
